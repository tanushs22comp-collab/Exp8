...
import shap
from model_utils import predict_sales, get_shap_values, model, background  # Make sure model & background imported
...
rating = st.sidebar.slider("Rating", 1, 5, value=3)  # Default in range
